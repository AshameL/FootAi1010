			...
			function timedCount(){
				...
				function f2(){
					if(y != results.length - 1){
						var point1 = results[y].get('point1');
						var point2 = results[y].get('point2');
						var point3 = results[y].get('point3');
						var point4 = results[y].get('point4');
						var point5 = results[y].get('point5');
						var point6 = results[y].get('point6');
						var point7 = results[y].get('point7');
						var point8 = results[y].get('point8');
						var point9 = results[y].get('point9');
						pointData.point1 = point1;
						pointData.point2 = point2;
						pointData.point3 = point3;
						pointData.point4 = point4;
